             ...
             */
					if (getWindowToken() != null) {
						...
						if (framework_err == MediaPlayer.MEDIA_ERROR_NOT_VALID_FOR_PROGRESSIVE_PLAYBACK) {
							messageId = "Progreso inválido";//com.android.internal.util.R.string.VideoView_error_text_invalid_progressive_playback;
						} else {
							messageId = "Error desconocido";//com.android.internal.R.string.VideoView_error_text_unknown;
						}
